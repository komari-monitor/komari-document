    ...
    "data": [
        {
            ...
            "auto_renewal": true,
            "currency": "$",
            "expired_at": "2026-04-13T00:00:00Z",
            "group": "新加坡",
            "tags": "",
            "hidden": false,
            "traffic_limit": 0,
            "traffic_limit_type": "max",
            "created_at": "2025-05-30T09:10:19.1305505Z",
            "updated_at": "2025-07-15T07:31:41.9808535Z"
        }
    ]
}
```
...
| `expired_at` | string \| null | 过期时间（UTC RFC3339Nano）；未设置时为 `null` |
| `group` | string | 节点分组 |
